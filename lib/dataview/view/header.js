    ...
    <Row className='m-0'>
      ...
      <Col xs='12' lg='auto' className='ms-auto my-auto'>
        <Row className='justify-content-end m-0'>
          ...
          {
            optionsResponsive && deviceSize.width > 575.98 ?
              (
                <Col className='col-auto pe-0 pr-0 my-auto'>
                  {
                    layoutButton(optionsResponsive, layout, onChangeLayout, deviceSize)
                  }
                </Col>
              )
              : ''
