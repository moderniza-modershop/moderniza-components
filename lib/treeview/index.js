  ...
  return (
    <div className="mdz-treeview">
      <View
        ...
        ref={viewRef}
        expandableSelected={options.expandableSelected}
        setExpandableSelected={options.setExpandableSelected}
        filterButton={options.filterButton}
        callbackFilter={options.callbackFilter}
