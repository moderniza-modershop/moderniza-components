  ...
  const renderMobile = () => {
    return (
      <Fragment>
        ...
        <Row>
          <Col xs="4" md="4" lg="4" className="d-flex justify-content-center align-itens-center my-auto pe-0 pr-0">
          ...
          <Col xs="4" md="4" lg="4" className="d-flex justify-content-end align-itens-center my-auto ps-0 pl-0">
            {button && (
              <Button
                type="button"
                size="small"
