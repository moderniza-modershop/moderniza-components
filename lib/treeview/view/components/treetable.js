      ...
      <Card>
        <CardBody>
          <Row className="mx-0 px-0 d-flex justify-content-between my-auto">
            <Col xs="12" sm="12" lg="6" className="d-flex justify-content-between align-itens-center p-0 my-auto mb-1">
            ...
            <Col
              ...
              md="12"
              lg={button ? "5" : "6"}
              className="d-flex justify-content-between align-itens-end p-0 my-auto"
            >
