      ...
      <Card>
        <CardBody>
          <Row className="mx-0 px-0 d-flex justify-content-between my-auto">
            <Col xs="12" sm="12" lg="6" className="d-flex justify-content-between align-itens-center p-0 my-auto">
            ...
            <Col
              ...
              md="12"
              lg={button ? "5" : "6"}
              className="d-flex justify-content-between align-itens-end p-0 mt-lg-0 mt-1"
            >
              ...
              <Col className="d-flex justify-content-end align-itens-center p-0 my-auto">
                <span className="p-buttonset mx-lg-1 my-auto">
                  <Button
                    size="small"
                    severity="primary"
                    icon={"pi pi-bars"}
