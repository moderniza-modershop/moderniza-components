      ...
      <Card className="mb-0">
        <CardBody className="px-50">
          <Row className="mx-0 px-0 d-flex justify-content-between my-auto">
            <Col xs="12" md="12" lg="12" className="d-flex justify-content-between align-itens-end p-0 mt-lg-0">
              <Col className="d-flex justify-content-start align-itens-center p-0 my-auto">
                ...
                <Button type="button" icon="pi pi-minus" size="small" outlined onClick={() => collapseAll()} />
              </Col>
