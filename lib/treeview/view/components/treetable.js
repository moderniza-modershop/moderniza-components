        ...
        <CardBody>
          <Row className="mx-0 px-0 d-flex justify-content-between my-auto">
            <Col
              ...
              sm="12"
              lg={button ? "11" : "12"}
              className="d-flex justify-content-between align-itens-center p-0 my-auto"
            >
  ...
  return (
    <div className="card">
      ...
      >
        ...
        <Column header="Ativo" body={actionTemplate} headerClassName="w-10rem" style={{ width: "80px" }} />
      </TreeTable>
    </div>
  )
}
